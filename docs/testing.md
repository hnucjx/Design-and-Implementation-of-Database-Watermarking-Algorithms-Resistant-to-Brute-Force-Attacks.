...
- 任务中心播放已下载单视频和 playlist 子视频，打开视频所在文件夹和 playlist 文件夹，复制任务/子视频源链接，跳转 YouTube 页面，缺少输出文件时按钮禁用。
...
11. 下载完成后点击播放按钮，确认系统默认视频播放器打开对应文件；点击视频/合集文件夹按钮，确认文件管理器打开对应目录。Windows 下文件夹应新开 Explorer 窗口，而不是只在任务栏闪烁。
